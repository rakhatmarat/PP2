...
for item in data:
    dn = item.get("l1PhysIf", {}).get("attributes", {}).get("dn", "")
    description = item.get("l1PhysIf", {}).get("attributes", {}).get("descr", "")
    speed = item.get("l1PhysIf", {}).get("attributes", {}).get("speed", "")
    mtu = item.get("l1PhysIf", {}).get("attributes", {}).get("mtu", "")
